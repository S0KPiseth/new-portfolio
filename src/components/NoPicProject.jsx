  ...
  return (
    ...
    >
      {hover ? (
        ...
        <div className="flex items-center justify-between w-full text-2xl lg:text-[4vw]">
          <p className="min-w-1/10 ">01</p>
          <p className="text-[#ffffffe4] text-center md:text-left grow text-nowrap">{props.name}</p>
