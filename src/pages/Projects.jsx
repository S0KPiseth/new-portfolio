...
export default function Projects() {
  return (
    <section className="test2 relative z-50 bg-black text-white">
      {/* <SectionHeader headerName="Projects" /> */}
      <div className="h-screen w-full flex flex-col">
        <p className="p-2.5 lg:text-[9vw] font-bold uppercase project">Project</p>
        <br />
        <div className="grow flex flex-col justify-between projectIntro">
          <div className="p-2.5 flex items-center justify-between">
            <p className="text-3xl w-3/5">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Minima ipsum optio voluptatum architecto fuga adipisci fugiat impedit nisi aperiam veniam. Impedit beatae voluptatibus corrupti at eaque fuga saepe magni officia.</p>
